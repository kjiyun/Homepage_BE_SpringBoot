...
public class TicketController {
    ...
    public ApiResponse<TicketGetResponse> viewTicketForm(@RequestParam(name = "reservationId") String reservationId) {
    ...
    public ApiResponse<TicketUpdateResponse> requestCancelForm(@RequestParam(name = "reservationId") String reservationId) {
